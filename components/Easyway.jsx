...
export default function Easyway() {
  return (
    <section
      className="relative py-20 md:py-28 bg-cover bg-center font-poppins overflow-hidden"
            ...
            >
              <div className="rounded-3xl bg-black/80 backdrop-blur p-6 overflow-hidden">
                ...
                <div className="flex gap-2">
                  ...
                  <select className="px-3 py-2 rounded-lg bg-black text-emerald-400 border border-emerald-500 outline-none">
                    <option>BTC</option>
                    <option>ETH</option>
                    <option>USDT</option>
                  </select>
