...
export default function Header() {
  return (
    <header className="fixed top-0 w-full z-50 bg-gradient-to-b from-[#05070f]/95 via-[#05070f]/85 to-transparent backdrop-blur-md border-b border-green-500/20">
      <nav className="max-w-7xl mx-auto px-4 md:px-8  flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#" className="text-green-200 hover:text-yellow-400 transition text-sm font-medium">
            Home
          </a>
          <a href="#" className="text-green-200 hover:text-yellow-400 transition text-sm font-medium">
            Games
